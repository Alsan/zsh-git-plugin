...
alias log='git --no-pager log --oneline --graph --decorate'
alias logp='git log --oneline --graph --decorate'
alias logs='git --no-pager log --graph --pretty=format:"%Cblue%h%Creset -%C(yellow)%d%Creset %s%Cgreen(%cr) %C(bold blue)%Creset"'
